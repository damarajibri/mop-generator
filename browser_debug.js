...
const techFields = {'hardware_requirements': 'Hardware Requirements', 'software_dependencies': 'Software Dependencies', 'network_prerequisites': 'Network Prerequisites', 'security_requirements': 'Security Requirements', 'personnel_requirements': 'Personnel Requirements', 'external_dependencies': 'External Dependencies', 'prep_start_time': 'Prep Start Time', 'prep_phase_duration': 'Prep Phase Duration', 'prep_activities': 'Prep Activities', 'impl_start_time': 'Implementation Start Time', 'impl_phase_duration': 'Implementation Phase Duration', 'impl_activities': 'Implementation Activities', 'verification_start_time': 'Verification Start Time', 'verification_duration': 'Verification Duration', 'verification_activities': 'Verification Activities', 'communication_frequency': 'Communication Frequency', 'notification_list': 'Notification List', 'technical_success_criteria': 'Technical Success Criteria', 'business_success_criteria': 'Business Success Criteria', 'rollback_commands': 'Rollback Commands', 'recovery_time_objective': 'Recovery Time Objective'};
